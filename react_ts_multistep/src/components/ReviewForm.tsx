    ...
    <div className="review-form">
      <div className="form-control score-container">
        ...
        <div className="form-control">
          ...
          <textarea name="comment" id="comment" placeholder="Conte com foi a sua expreriência com o produto..." required value={data.comment || ""} onChange={(e) => updateFieldHandler("comment", e.target.value)}></textarea>
        </div>
    </div>
  )
}
